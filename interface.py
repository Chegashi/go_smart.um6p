...
f5 = F(frame3, 3, 3, path +'Roof F.PNG',path +'Roof O.png', NORMAL)
...
l9 = lumiere(frame2, 4, 3, path +'Salon off.PNG',path +'Salon on.png', NORMAL)
...
l10 = lumiere(frame2, 6, 3, path +'Couloir off.PNG',path +'Couloir on.png', NORMAL)
